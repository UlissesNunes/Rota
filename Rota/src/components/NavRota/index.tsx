...
export function NavRota({ variant = "horizontal", onNavigate }: NavRotaProps) {
  ...
  const linkClass =
    variant === "vertical"
      ? "rounded-md px-3 py-2 text-sm sm:text-base font-medium text-slate-700 hover:bg-slate-100 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-300"
